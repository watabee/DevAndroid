...
object Deps {
    ...
    object Kotlin {
        ...
        const val reflect = "org.jetbrains.kotlin:kotlin-reflect:1.4.20"
    ...
    object Flipper {
        const val flipper = "com.facebook.flipper:flipper:0.66.0"
        const val networkPlugin = "com.facebook.flipper:flipper-network-plugin:0.66.0"

        const val flipperNoOp = "com.facebook.flipper:flipper-noop:0.66.0"
    }
