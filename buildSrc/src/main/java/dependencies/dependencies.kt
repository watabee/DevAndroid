...
object Deps {
    ...
    object Kotlin {
        ...
        object Coroutines {
            ...
            const val android = "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.3.8"
            const val test = "org.jetbrains.kotlinx:kotlinx-coroutines-test:1.3.8"
        }
    }
    ...
    object Flipper {
        const val flipper = "com.facebook.flipper:flipper:0.50.0"
        const val networkPlugin = "com.facebook.flipper:flipper-network-plugin:0.50.0"

        const val flipperNoOp = "com.facebook.flipper:flipper-noop:0.50.0"
    }
