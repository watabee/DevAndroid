...
object Deps {
    ...
    object Flipper {
        const val flipper = "com.facebook.flipper:flipper:0.64.0"
        const val networkPlugin = "com.facebook.flipper:flipper-network-plugin:0.64.0"

        const val flipperNoOp = "com.facebook.flipper:flipper-noop:0.64.0"
    }
